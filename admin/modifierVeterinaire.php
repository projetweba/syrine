        ...
        <div class="side-nav-inner">
            <ul class="side-nav-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <span class="title">MY RECLAMTIONS</span>
                    <span class="arrow">
            ...
            <li>
                <a href="afficherReclamation.php">Reclamation</a>
                </li>
            </ul>
...
if (isset($_GET['id'])){
    ...
    $result=$veterinaireC->recupererVeterinaire($_GET['id']);
...
<div class="col-12">
    ...
    modifier les information du Veterinaire
    </p>
    <form method="POST" name="hey" class="forms-sample" onsubmit="return verifForm(this)" >
    <div class="form-group">
    <label for="exampleInputName1">Nom du Veterinaire</label>
    <input type="text" name="nom" value="<?PHP echo $nom ?>" class="form-control" id="exampleInputName1" placeholder="Nom" onblur="verifname(this)">
    </div>
    <div class="form-group">
    <label for="exampleInputEmail3">Prenom du Veterinaire </label>
    <input type="text" name="prenom" value="<?PHP echo $prenom ?>" class="form-control" id="exampleInputName2" placeholder="Prenom..." onblur="verifname(this)">
    </div>
    <div class="form-group m-b-20">
            <label for="exampleTextarea1">Description</label>
            <input class="form-control" name="description" value="<?PHP echo $description ?>" id="exampleTextarea1" rows="4" onblur="verifname(this)" >
            </div>
            <div class="form-group">
                    <label>File upload</label>
                    <div class="custom-file">
                    <input type="text" name="image" value="<?PHP echo $image ?>" class="form-control" id="inputGroupFile02">
    ...
    <select class="form-control" name="city" id="exampleSelectGender" >
    ...
    <input type="text" name="adresse" value="<?PHP echo $adresse ?>"value="<?PHP echo $nom ?>" class="form-control" id="exampleInputCity1" placeholder="Adresse.." onblur="verifname(this)">
    ...
    <button class="btn btn-light" href="afficherVeterinaire.php">Cancel</button>
    </form>
    </div>
    </div>
    </div>
...
if (isset($_POST['modifier'])){
	$veterinaire=new veterinaire($_POST['nom'],$_POST['prenom'],$_POST['image'],$_POST['description'],$_POST['city'],$_POST['adresse']);
	$veterinaireC->modifierVeterinaire($veterinaire,$_POST['id_ini']);
