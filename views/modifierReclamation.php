                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-5">
                            <div class="logo pt-39">
                                <a href="index.html"><img alt="" src="assets/img/logo/logo-2.png"></a>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="contact-form-style mb-20">
												<input name="fullNameC" type="text"  value="<?PHP echo $fullNameC ?>"/>
                                        ...
                                        <div class="col-lg-12">
											...
											<input name="message" type="text"  value="<?PHP echo $message ?>"/>
...
if (isset($_POST['modifier'])){
	$reclamation=new reclamation($_POST['fullNameC'],$_POST['email'],$_POST['subject'],$_POST['message'],0);
